...
namespace MoviesDAL.Data {
	public class MovieListDAL : IDataAccessLayer {
		private static List<Movie> MovieList = new List<Movie>{
			...
			new Movie("Spider-Man 2", 2004, 5.0f, null, "https://m.media-amazon.com/images/M/MV5BMzY2ODk4NmUtOTVmNi00ZTdkLTlmOWYtMmE2OWVhNTU2OTVkXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_.jpg"),
		...
		public IEnumerable<Movie> SearchForMovies(string key) {
			return MovieList.Where(m => m.Title.ToLower().Contains(key.ToLower()));
		}
